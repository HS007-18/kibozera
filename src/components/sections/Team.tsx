          ...
          >
            ...
            <div className="relative rounded-2xl p-8 md:p-10 border border-white/8 overflow-hidden"
              ...
              <div className="relative z-10">
                ...
                {/* Name */}
                <h2
                  className="font-display-lg text-4xl md:text-5xl font-black mb-4 leading-snug"
                  style={{ color: "#fff" }}
                >
                  {member.name}
                ...
                {/* Education */}
                {member.education && (
                  <div className="inline-flex items-center gap-2 mb-6 text-xs text-on-surface-variant/70">
                ...
                {/* Contact buttons */}
                <div className="flex flex-wrap gap-3 mt-8 pt-6 border-t border-white/8">
                  {member.linkedin && (
                    <a
                      href={member.linkedin}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold border transition-all duration-300 hover:scale-105 hover:shadow-lg"
                      style={{
                  ...
                  {member.phone && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold border border-white/10 text-on-surface-variant transition-all duration-300 hover:scale-105 hover:border-white/25 hover:text-white"
                    >
                      {/* Phone icon */}
